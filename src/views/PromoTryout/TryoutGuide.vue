...
const instagramAccountUrl = computed(() => route.query.instagram || "https://instagram.com/kuy_dinas")
const instagramPostUrl = computed(
  () => route.query.postingan || route.query.post_url || route.query.ig_post_url || instagramAccountUrl.value
)
...
const whatsappUrl = computed(() => `https://wa.me/?text=${encodeURIComponent(whatsappShareMessage.value)}`)
