    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div v-else class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
        ...
        <div class="p-8 space-y-8">
          <section>
            ...
            <div class="bg-slate-50 rounded-2xl p-6 space-y-4 text-slate-800 text-sm leading-relaxed border border-slate-100">
              ...
              <div class="flex gap-3">
                ...
                <p>Jawaban akan tersimpan otomatis setiap ada interaksi pada sesi tryout.</p>
              </div>
              <div class="flex gap-3">
          ...
          <p v-if="startError" class="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm font-medium text-rose-600">
            {{ startError }}
          </p>
          ...
          <div class="flex flex-col gap-3">
            ...
            <button
              @click="back"
              :disabled="isStarting"
              class="w-full py-3 rounded-2xl bg-white text-slate-600 font-semibold border border-slate-200 hover:bg-slate-50 transition disabled:opacity-60"
            >
              Kembali
            </button>
          </div>
